...
return (new CustomEvent(event_name,(function (){var obj30718 = ({"detail":data});
return obj30718;
})()));
} else {
...
var f = (function (){var pred__30725 = cljs.core._EQ_;
var expr__30726 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30725.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30726))){
return (function (p1__30719_SHARP_){
return console.warn(p1__30719_SHARP_);
});
} else {
if(cljs.core.truth_(pred__30725.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30726))){
return (function (p1__30720_SHARP_){
return console.debug(p1__30720_SHARP_);
});
} else {
if(cljs.core.truth_(pred__30725.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30726))){
return (function (p1__30721_SHARP_){
return console.error(p1__30721_SHARP_);
});
} else {
return (function (p1__30722_SHARP_){
return console.log(p1__30722_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30729){
var map__30730 = p__30729;
var map__30730__$1 = cljs.core.__destructure_map.call(null,map__30730);
var opts = map__30730__$1;
var eval_fn = cljs.core.get.call(null,map__30730__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__30731_SHARP_){
return new_def.callback(p1__30731_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__30732){
var vec__30733 = p__30732;
var ky = cljs.core.nth.call(null,vec__30733,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1643275181133
