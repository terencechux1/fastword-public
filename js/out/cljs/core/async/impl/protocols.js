...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26929 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26929.call(null,port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26930 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26930.call(null,port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26931 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26931.call(null,chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26932 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26932.call(null,chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26933 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26933.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26934 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26934.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26935 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26935.call(null,h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26936 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26936.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26937 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26937.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26938 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26938.call(null,b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26939 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26939.call(null,b);
}
});
...
//# sourceMappingURL=protocols.js.map?rel=1643275179504
