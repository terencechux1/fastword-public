...
var G__25688 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__25688,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25690__i < G__25690__a.length) {G__25690__a[G__25690__i] = arguments[G__25690__i + 0]; ++G__25690__i;}
  args = new cljs.core.IndexedSeq(G__25690__a,0,null);
} 
...
var G__25692 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__25692,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25694__i < G__25694__a.length) {G__25694__a[G__25694__i] = arguments[G__25694__i + 0]; ++G__25694__i;}
  args = new cljs.core.IndexedSeq(G__25694__a,0,null);
} 
...
var G__25696 = props;
var G__25696__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25696,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25696);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25696__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__25697 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25697,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__25697;
}
})(),id_class);
...
var G__25698 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25698) {
case (0):
...
var vec__25700 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25700,(0),null);
var id = cljs.core.nth.call(null,vec__25700,(1),null);
var className = cljs.core.nth.call(null,vec__25700,(2),null);
...
var temp__5757__auto___25703 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___25703 == null)){
} else {
var key_25704 = temp__5757__auto___25703;
(jsprops.key = key_25704);
}
...
var temp__5757__auto___25705 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___25705 == null)){
} else {
var key_25706 = temp__5757__auto___25705;
(jsprops.key = key_25706);
}
...
var temp__5757__auto___25707 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___25707 == null)){
} else {
var key_25708 = temp__5757__auto___25707;
...
var temp__5757__auto___25709 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___25709 == null)){
} else {
var key_25710 = temp__5757__auto___25709;
...
var temp__5757__auto___25711 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___25711 == null)){
} else {
var key_25712 = temp__5757__auto___25711;
(jsprops.key = key_25712);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__25713_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__25713_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25714 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__25714,(0),null);
var derefed = cljs.core.nth.call(null,vec__25714,(1),null);
...
break;
default:
var G__25719 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template25724 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template25724 = (function (opts,id,fn_to_element,parse_fn,meta25725){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta25725 = meta25725;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template25724.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25726,meta25725__$1){
var self__ = this;
var _25726__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25724(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25725__$1));
}));

(reagent.impl.template.t_reagent$impl$template25724.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25726){
var self__ = this;
var _25726__$1 = this;
return self__.meta25725;
}));

(reagent.impl.template.t_reagent$impl$template25724.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25724.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25724.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template25724.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25724.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25724.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25725","meta25725",-883067732,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25724.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25724.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25724");

(reagent.impl.template.t_reagent$impl$template25724.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template25724");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25724.
 */
reagent.impl.template.__GT_t_reagent$impl$template25724 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template25724(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta25725){
return (new reagent.impl.template.t_reagent$impl$template25724(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta25725));
});

}

return (new reagent.impl.template.t_reagent$impl$template25724(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1643275178264
